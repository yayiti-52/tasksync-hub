...
import { Calendar, User, Flag, MessageSquare, Send, Tag, Bell } from 'lucide-react';
import { Dialog, DialogContent, DialogHeader, DialogTitle } from '@/components/ui/dialog';
import { Button } from '@/components/ui/button';
import { Textarea } from '@/components/ui/textarea';
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@/components/ui/select';
import { Task, Profile, TaskComment } from '@/hooks/useTasks';
import { useTaskDocumentation } from '@/hooks/useTaskDocumentation';
...
export const TaskDetailModal = ({
  ...
  const { documentation, saveDocumentation } = useTaskDocumentation(task?.id || null);
  ...
  const handleSendReminder = async (message: string) => {
    if (task.assignee_id) {
      await sendReminder(task.id, task.assignee_id, message);
    }
  };
